...
(* OASIS_START *)
(* DO NOT EDIT (digest: fbf3105c792cbcf36b6aa1d078b370a2) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_nativeopt = [(OASISExpr.EBool true, ["-S"; "-g"])]
                   },
                   {
                      lib_modules =
                        [
                      ...
                      lib_internal_modules =
                        ["Bigstring"; "Message"; "Parse"; "Serialize"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "httpaf";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "httpaf_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "httpaf";
                           FindlibPackage ("faraday.async", None);
                      ...
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, ["-g"])]
                   },
                   {
                      lib_modules = ["Httpaf_async"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "httpaf";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Httpaf_effects"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "httpaf";
                      lib_findlib_name = Some "effects";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "wrk_async_benchmark";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "wrk_async_benchmark.ml"
                   });
               Executable
                 ({
                     cs_name = "wrk_effects_benchmark";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "httpaf_effects";
                           FindlibPackage ("aeio", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "wrk_effects_benchmark.ml"
                   });
               Executable
                 ({
                     cs_name = "test_angstrom";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "lib_test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "httpaf"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "test_httpaf.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "P\018o\253\176+;\206\205\136\017\203\162\160\193G";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
