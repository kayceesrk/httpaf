(* OASIS_START *)
(* DO NOT EDIT (digest: 5d24d341c0724f385fefba30f12ae215) *)
     ...
     flags =
       [
          ...
          (["oasis_library_httpaf_async_native"; "ocaml"; "compile"; "native"
            ...
            [(OASISExpr.EBool true, S [A "-g"])]);
          (["oasis_library_httpaf_effects_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-g"])]);
          ([
              "oasis_library_httpaf_effects_native";
              "ocaml";
              "ocamldep";
              "native"
           ],
          ...
          ([
            ...
            [(OASISExpr.EBool true, S [A "-g"])]);
          ([
              "oasis_executable_wrk_effects_benchmark_native";
              "ocaml";
              "link";
              "native"
           ],
